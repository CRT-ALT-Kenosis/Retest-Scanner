...
def gist_save_watchlist(watchlist_dict):
    ...
    try:
        ...
        if gist_id:
            ...
            payload = {
                "description": "Scanner Watchlist — auto-managed by Retest Scanner",
                "public": False,
            ...
            if r.status_code == 201:
                ...
                # Show the new gist ID so user can paste it into secrets
                st.toast(f"✅ Gist created! Add this to your Streamlit secrets → gist_id = \"{new_id}\"",
                         icon="🔗")
                return True
    except Exception:
        pass
...
gist_id = ""
```
5. Save secrets → app restarts → star any ticker → Gist auto-creates
6. Copy the Gist ID from the green toast → paste into secrets as `gist_id` → save again
                """)
