            ...
            def render_category(label, emoji, cat_class, group):
                ...
                for h in group:
                    ...
                    html = (
                        ...
                        f'<span class="score-chip" title="Raw {raw_score}/125">{score}/100</span>' +
                        (f'<span style="font-family:DM Mono,monospace;font-size:0.55rem;color:var(--amber);margin-left:3px">+{bonus_score}b</span>' if bonus_score > 0 else '') +
                        f'</div></div>' +
